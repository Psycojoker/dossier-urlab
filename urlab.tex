...
De plus, des mesures seront prises afin d'éviter tout danger notamment la mise en place de règles pour l'emploi du matériel (les puissances électriques employées sont d'une grandeur électronique; l'outil le plus problématique sera probablement le fer à souder). Avec une bonne politique de prévention des risques, ce local ne serait pas plus dangereux qu'une salle de TP machine.
...
propose toute une série d'activités culturelles, mais comme un sondage réalisé par le CI parmi les étudiants de BA1 et de BA2
le montre, cela fait partie des activités extra-scolaires les moins populaires}.
Avec un laboratoire ouvert aux étudiants, nous pensons susciter la curiosité et l'envie d'apprendre, ce qui pourrait diminuer à terme le décrochage
universitaire.
...
Sur place, il sera possible d'acheter des boissons (café, club mate, coca, etc. , mais  
...
le hackerspace leur permettra de trouver des personnes avec des idées sur lesquelles travailler.
...
\item de visualiser les projets (définition, explications, feuille de route, informations utiles, etc.) 
du hackerspace en cours ainsi que les projets planifiés
\item de permettre aux membres d'adhérer à un ensemble de projets pour lesquels ils sont prêt à s'investir
\item de lancer les projets qui ont atteint un seuil critique de définition et sur lequel suffisamment de gens sont prêts à travailler
\item de coordonner la force de travail sur plusieurs projets en cas de mise en pause forcée d'un des projets
\end{itemize}
...
Puis, une rencontre avec Markus Lindström et Stephane Fermandes Medeiros, assistants au DI, nous a convaincu de la possibilité d'obtention d'un local à
l'ULB si nous présentions un projet concret et sérieux. Nous avons alors changé de mode
opératoire pour se tourner vers un projet "infrastructure-driven" (endroit, connectivité, serveurs..),
